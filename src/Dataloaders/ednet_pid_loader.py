...
DATASET_DIR = "../data/EdNetKT1/preprocessed_df.csv"
IKT_DIR = "../data/EdNetKT1/IKT/"
...
class IKT_HANDLER:
    ...
    def format_to_ikt(self):
        ...
        for user in users:
            ...
            file_name = IKT_DIR + f'ednet_ikt_{self.save_name}.csv'
...
def EDNET_PID_SPLIT(max_seq_len, dataset_dir=DATASET_DIR):
    ...
    # create the EDNET loaders from this data
    validation_loader = EDNET_PID(max_seq_len, valid_data, "valid", fe)
    train_loader = EDNET_PID(max_seq_len, train_data, "train", fe)
    test_loader = EDNET_PID(max_seq_len, test_data, "test", fe)
