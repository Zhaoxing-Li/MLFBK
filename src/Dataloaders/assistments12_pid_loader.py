...
DATASET_DIR = "../data/assistments12/preprocessed_df.csv"
IKT_DIR = "../data/assistments12/IKT/"
...
class ASSISTMENTS12_PID(Dataset):
...
class IKT_HANDLER:
    ...
    def format_to_ikt(self):
        ...
        for user in users:
            ...
            file_name = IKT_DIR + f'assistments12_ikt_{self.save_name}.csv'
...
def ASSISTMENTS12_PID_SPLIT(max_seq_len, dataset_dir=DATASET_DIR):
    ...
    # create the ASSISTMENTS12_PID loaders from this data
    validation_loader = ASSISTMENTS12_PID(max_seq_len, valid_data, "valid", fe)
    train_loader = ASSISTMENTS12_PID(max_seq_len, train_data, "train", fe)
    test_loader = ASSISTMENTS12_PID(max_seq_len, test_data, "test", fe)
