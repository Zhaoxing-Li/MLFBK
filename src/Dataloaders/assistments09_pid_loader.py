...
DATASET_DIR = "../data/assistments09/preprocessed_df.csv"
IKT_DIR = "../data/assistments09/IKT/"
...
class ASSISTMENTS09_PID(Dataset):
...
class IKT_HANDLER:
    ...
    def format_to_ikt(self):
        ...
        for user in users:
            ...
            file_name = IKT_DIR + f'assistments09_ikt_{self.save_name}.csv'
...
def ASSISTMENTS09_PID_SPLIT(max_seq_len, dataset_dir=DATASET_DIR):
    ...
    # create the ASSISTMENTS09_PID loaders from this data
    validation_loader = ASSISTMENTS09_PID(max_seq_len, valid_data, "valid", fe)
    train_loader = ASSISTMENTS09_PID(max_seq_len, train_data, "train", fe)
    test_loader = ASSISTMENTS09_PID(max_seq_len, test_data, "test", fe)
